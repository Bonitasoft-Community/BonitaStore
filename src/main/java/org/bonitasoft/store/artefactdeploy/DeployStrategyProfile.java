...
public class DeployStrategyProfile extends DeployStrategy {
  ...
  @Override
  public DeployOperation detectDeployment(Artefact artefactProfile, BonitaAccessor bonitaAccessor, LoggerStore logBox) {
  ...
  @Override
  public DeployOperation deploy(Artefact artefactProfile, BonitaAccessor bonitaAccessor, LoggerStore logBox) {
